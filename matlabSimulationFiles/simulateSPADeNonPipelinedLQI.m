function [time,time_u,yL,df,MSE,ST] = simulateSPADeNonPipelinedLQI(h,tauSystemScenarios,phi,Gamma,C_aug,K,F,pattern,SIMULATION_TIME,fh,reference,SYSTEM_MODEL)
% SIMULATESPADENONPIPELINED - A function to simulate the LQI SPADe design in Matlab for non-pipelined implementation
% Arguments:
...
for loop=1:num_plots
    ...
    clear timeY timeU u y x0 z0 mse_reference  
end
